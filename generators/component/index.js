...
const utils = require('../app/utils/all');
 ...
 */
  ...
  writing() {
    ...
    this.fs.copyTpl(
      ...
      //destination path `test` parallel to `src` folder, `${testPath.path}/components/${componentPartPath}/
      //filename is `${componentBaseName}Test.js`
      settings
    );
  }
}
